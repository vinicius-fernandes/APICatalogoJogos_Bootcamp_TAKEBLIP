using APICatalogoJosos.Exceptions;
using APICatalogoJosos.InputModel;
using APICatalogoJosos.Services;
...
namespace APICatalogoJosos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="pagina">Indica a página sendo consultada, valor minimo 1</param>
        /// <param name="quantidade">Quantidade por página. Minimo 1 e máximo 50</param>
        /// <returns></returns>
        [HttpGet]
        ...
        /// </summary>
        /// <param name="idJogo">Id identificador do jogo</param>
        /// <returns></returns>
        [HttpGet("{idJogo:guid}")]
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute]Guid idJogo,[FromBody] JogoInputModel jogoInputModel)
        {
            ...
            {
                return NotFound("Esse jogo não existe no sistema!");
            }
